# Journey Builder Activity Web Push Template
### JB Activity form for push notification template creation using Node.JS
...
* Postmonger: javascript plugin to make it easier to interact between iframes in two different domains.
* Browserify: Used in place of require.js and jQuery. Browserify lets you use require in the browser, the same way you'd use it in Node. It's a tool that brings all the resources NPM ecosystem off of the server, and into the client.
* Used https://mock-countries.herokuapp.com/list/ to fetch countries list and show on the form.
* config.json - Application extension that defines the custom activity.
* customActivity.js - Contains Postmonger events and sits in between your configuration app in the iframe and Journey Builder.
